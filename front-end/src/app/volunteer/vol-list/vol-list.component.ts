...
export class VolListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.serverService.data_type = "volunteers"

    this.serverService.addAttributeFunc = this.volservice.m_fun;
    this.serverService.arrangeInUiFunc = this.volservice.arrangeInUi;
    this.eventService.data_formate = this.volservice.template_volunteer;
  }
