...
export class EventService {
  ...
  constructor() {
    ...
    // this.relatedTo = [
    //   new VolunteerModel("m", "20541774", new Date, "beit-hanina", "0524651749", "",
    ...
    //     "025859294", "AHMADLOXIZ@gmail.com", "cat", new FreeDayes(true, false, true, true, true, false, false), true, false, "software engineering", "", []),
    //   new VolunteerModel("a", "20541774", new Date, "beit-hanina", "0524651749", "",
    //     "025859294", "AHMADLOXIZ@gmail.com", "cat", new FreeDayes(true, false, true, true, true, false, false), true, false, "software engineering", "", []),
    // ];
    // this.didntarrived = this.relatedTo;
    // this.commingSoonEvents = [ //year,month,date	   //TODO
    //   new EventModel("1", "volunteer-Model", new Date(2018, 1, 8), "שלח כרטיס מתנה", Object.assign([], this.relatedTo), [], Object.assign([], this.didntarrived)),
    //   new EventModel("2", "volunteer-Model", new Date(2018, 2, 8), "שלח כרטיס מתנה", Object.assign([], this.relatedTo), [], Object.assign([], this.didntarrived)),
    //   new EventModel("3", "volunteer-Model", new Date(2018, 3, 8), "שלח כרטיס מתנה", Object.assign([], this.relatedTo), [], Object.assign([], this.didntarrived)),
    //   new EventModel("4", "volunteer-Model", new Date(2018, 0, 8), "שלח כרטיס מתנה", Object.assign([], this.relatedTo), [], Object.assign([], this.didntarrived)),
    //   new EventModel("5", "volunteer-Model", new Date(2018, 4, 8), "שלח כרטיס מתנה", Object.assign([], this.relatedTo), [], Object.assign([], this.didntarrived)),
    //   new EventModel("6", "volunteer-Model", new Date(2018, 5, 3), "שלח כרטיס מתנה", Object.assign([], this.relatedTo), [], Object.assign([], this.didntarrived)),
